...
public class ImagePanel extends JPanel {
	 ...
	 */
	public ImagePanel(BufferedImage image, String title) throws IOException {
		this();
...
public class ImagePanel extends JPanel {
	...
	public ImagePanel() {
		...
		setSize(dim);
		graphic = new Graphic(dim);
		graphic.setPreferredSize(dim);
		setLayout(new BorderLayout());
	...
	public void setImage(BufferedImage newImage) {
		graphic.setCurrent(newImage);
		callPaint(getGraphics());
	}
